...
//************************************************************//
//************************************************************//
//************** Alumno (s): Martinez Torres Luis Martin *********************************//
//*************											******//
//*************											******//
//************************************************************//

#include "p10/texture.h"
#include "casa/Casa3/figuras.h"
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	casita._3dsLoad("p12/Dollshouse.3ds");

	oldhouse._3dsLoad("p12/oldhouse/oldhouse.3ds");
...
void animacion()
{
	...
	if (circuito) 
	{
		if (recorrido1)//comienza recorrido 1
		{
			movKitZ++;
			if (movKitZ > 156)
			{
		...
		if (recorrido2)// Comienza recorrido 2
		{
			rotKit = 90;
			movKitX++;
			if (movKitX > 126)//transicion a 3
			{
				recorrido2 = false;
				recorrido4 = true;
		...
		if (recorrido3)//comienza recorrido 3
		{
			rotKit = 90;
			movKitX--;
			movKitZ--;
			if (movKitZ < 0)//recorrido 4
			{
				recorrido3 = false;
				recorrido4 = true;
			}
		...
		if (recorrido4)//recorrido 4
		{
			...
			movKitX--;
			movKitZ -= 2.5;
			if (movKitZ < -155 && movKitX < 0)//cambio a recorrido 5
		...
		if (recorrido5)//recorrido 5
		{
			rotKit = 0;
			movKitZ++;
			if (movKitZ > 0)//Se cambia recorrido al 1 del 5
			{
				recorrido5 = false;
				recorrido1 = true;
			}
	...
	////Se hace el recorrido en reversa


	if (circuito2) //comienza maquina de estados
	{
