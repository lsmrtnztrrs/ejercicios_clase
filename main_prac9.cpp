...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	esfera.LoadTGA("esfera.tga");
	esfera.BuildGLTexture();
	esfera.ReleaseImage();

	regalo.LoadTGA("regalo.tga");
...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glPushMatrix();
		...
		glAlphaFunc(GL_GREATER, 0.1);
		glTranslatef(0, 10, 0);
		fig1.esfera(4, 15, 15, carita.GLindex);
		glDisable(GL_ALPHA_TEST);
		glPopMatrix();
		...
		glAlphaFunc(GL_GREATER, 0.1);
		glTranslatef(0, 2, 0);
		fig1.cono(4, 2, 15, arbol2.GLindex);
		glDisable(GL_ALPHA_TEST);
		glPopMatrix();
		...
		glAlphaFunc(GL_GREATER, 0.1);
		glTranslatef(0, 3, 0);
		fig1.cono(6, 2, 15, arbol2.GLindex);
		glDisable(GL_ALPHA_TEST);
		glPopMatrix();
		...
		glAlphaFunc(GL_GREATER, 0.1);
		glTranslatef(0, 0, 0);
		fig1.cilindro(1, 3, 15, madera.GLindex);
		glDisable(GL_ALPHA_TEST);
		glPopMatrix();
